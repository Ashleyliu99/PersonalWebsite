...
const projects = [
  ...
  },
  {
    ...
    desc: "Normalized SQL relational database — database design, Python data pipeline, and business-driven queries analyzing pricing, market speed, and buyer/seller behavior.",
    tags: ["MySQL", "Database Design", "Python", "SQL Analytics"],
    links: { page: "Project 3/index.html" },
  },
  {
    image: "Project 3 - new/figures/figure6.png",
    title: "Customer Segmentation for E-Commerce",
    desc: "End-to-end Machine Learning workflow on 1M+ online retail transaction, covering exploratory data analysis, model training, and business recommendations.",
    tags: ["Python", "Machine Learning", "Model Training", "EDA"],
    links: { page: "Project 3 - new/index.html" },
  },
];
